              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    {mode === "signin" && "Sign in to your AlgoTrek account"}
                    {mode === "signup" && "Start your coding interview journey"}
              ...
              <div className="mt-6 text-center">
                {mode === "signin" && (
                  <div className="space-y-2">
                    <button onClick={() => switchMode("forgot")} className="text-algotrek-aqua hover:underline text-sm">
